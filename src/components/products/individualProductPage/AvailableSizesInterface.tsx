...
type Props = {
    availableSizes: ClothingSize[] | 'non-applicable',
...
export default function AvailableSizesInterface(props: Props) {
    ...
    return <>
    {props.availableSizes === 'non-applicable' ? // Available sizes interface, only shown in products for which you have to pick a size
